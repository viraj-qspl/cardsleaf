...
abstract class Base_list {
	...
	/** This variable holds the limit value on db query. The position value for this can vary on URL depending 
	 * upon number of parameters on the URL. Hence, you can provide the exact position of limit offset 
	 * using this variable. The default position (URI_LIMIT_OFFSET) has been defined in CONSTANT file.
	 */
