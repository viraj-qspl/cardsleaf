    ...
    <div style="width: 100%; height: 114px; margin: 0; font-family: Arial;">
    	<div style="width: 100%; height: 20px; background: #34363a; color: #989BA2; font-size: 12px; padding: 15px 0; font-family: Arial;">
        	<ul style="padding: 0; margin: 0 auto; display: table;">
            	...
            	<li style="padding: 0; margin: 0; list-style-type: none; float: left;"><a href="'.site_url('home/page/team').'" style="color: #989BA2;">Team</a></li>
                <li style="padding: 0; margin: 0 5px; list-style-type: none; float: left; color: #989BA2;"> | </li>
                <li style="padding: 0; margin: 0; list-style-type: none; float: left;"><a href="'.site_url('home/page/careers').'" style="color: #989BA2;">Careers</a></li>
                <li style="padding: 0; margin: 0 5px; list-style-type: none; float: left; color: #989BA2;"> | </li>
                <li style="padding: 0; margin: 0; list-style-type: none; float: left;"><a href="'.site_url('home/page/press_media').'" style="color: #989BA2;">Press & Media</a></li>
                <li style="padding: 0; margin: 0 5px; list-style-type: none; float: left; color: #989BA2;"> | </li>
	...
	{		
		if($this->session->userdata('login_mode')=="facebook")
		{
			$facebook = new Facebook(array(
				...
				'secret' => '77df95723a9514b5edc90df7b9a79e89',
			));
