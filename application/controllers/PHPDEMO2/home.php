		   ...
		   /** PDF CREATION CODE START **/
			...
			elseif($viewpage == 'create_pdf_h')
			{
				...
				if($temp)
				{
					...
					$pdf_html = str_replace('img','img height="70%" ',$pdf_html);
				...
				if($temp)
					$pdf_html2 = strstr($temp,'</div>',true);
				

					
					
					$pdf_html = '<div id="wrapper" style="width:504px;height:360px;border:1px solid black;margin:auto;"><div style="position:relative;top:57px;left:152px;">'.$pdf_html.'</div><div style="clear:both"></div></div>'; 
					
					$pdf_html1 = '<div id="wrapper" style="width:504px;height:360px;border:1px solid black;margin:auto;position:relative;top:50px;"><div style="top:50%;position:relative;text-align:center;">'.$pdf_html1.'</div></div>'; 
					...
					$pdf_html2 = str_replace('<div id="marker" style="background: none repeat scroll 0 0 #FFFFFF; display: block; height: auto; margin: 270px auto 0; text-align: center; width: 135px;">','<div id="marker" style="background: none repeat scroll 0 0 #FFFFFF; display: block; height: auto; text-align: center; width: 98%;position:relative;top:210px;">',$pdf_html2);
