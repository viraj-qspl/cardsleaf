		    ...
		    success: function(response){
					   ...
					   // alert(response);
					    ...
					    $("div#img_txt2>span").html(obj.recentCardDetails.txt2.replace(/\n/g,"<br>"));
                                            // alert(obj.recentCardDetails.txt2);
...
<div class="mid_container" style="padding: 60px 0px; overflow: hidden;">
	<div class="landscape_left">
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01-h.png" border="0" alt="" />Front</a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page02-h.png" border="0" alt="" />Side</a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page03-h.png" border="0" alt="" />Middle</a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page04-h.png" border="0" alt="" />Back</a></li>
            </ul>
        </div>
	</div>
