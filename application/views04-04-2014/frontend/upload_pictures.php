...
<div class="mid_container" style="padding: 60px 0px;overflow: hidden;">
	<div class="leftcardpl">
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01.png" border="0" alt="page01" />Front</a></li>
