    ...
    $('#image_file').live('change', function() { 
		...
		$("#imageform").ajaxForm({
			...
			aspectRatio: 200 / obj.newHeight_0,
		      ...
		      // ratan:11-03-2014
                        var sub = 360-parseInt(obj.newHeight_0);
                        var top  = parseInt(sub)/2;
			 $("#rnd").css("left",152);
...
<div class="mid_container" style="padding: 60px 0px; overflow: hidden;">
	<div class="landscape_left">
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01-h.png" border="0" alt="" /></a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page02-h.png" border="0" alt="" /></a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page03-h.png" border="0" alt="" /></a></li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page04-h.png" border="0" alt="" /></a></li>
            </ul>
        </div>
	</div>
