...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var d = new Date();
        var current_year = parseInt(d.getFullYear()) + parseInt("10");

        //$("#f_dob").datepick({defaultDate: '1980-01-01', yearRange: '1980:' + current_year, dateFormat: 'yyyy-mm-dd'});
        $("#d_dt").datepick({defaultDate: '<?php echo date("m/d/Y"); ?>', yearRange: '2014:' + current_year, dateFormat: 'mm/dd/yyyy',minDate: 'today'});
    });
    ...
    function pickaddbyimg(img)
    {
        ...
        $.ajax({
            ...
            success: function(html) {
                ...
                //html = $.parseJSON(html);
                $("#rname").val(html.name);
                $("#f_dob").val(html.f_dob == '0000-00-00' ? '' : html.f_dob);
...
<div class="mid_container">
    ...
    <?php if ($receiver_addDtls) { ?>
        <div id='carousel_container'>
            ...
            <div id='carousel_inner'>
                <?php //echo count($receiver_addDtls);?> 
                <ul id='carousel_ul'>
                    <?php foreach ($receiver_addDtls as $eachAdd) { ?>
                        <li><a onclick="pickaddbyimg(<?php echo $eachAdd['img_id']; ?>)" style="cursor: pointer;">
                                <div class="thumb">
                                    ...
                                    <p><strong>Address 1 : </strong><?php echo isset($eachAdd['reciver_add1']) ? $eachAdd['reciver_add1'] : ''; ?></p>
    ...
    <div class="row_form">
        ...
        <form method="post" action="" enctype="multipart/form-data" name="address_form" id="address_form" autocompete="off">
            ...
            <span class="rightdivbox" ><select name="r_country" id="r_country" class="dropdown2" style="width: 334px;" >
            ...
            <span class="rightdivbox">
                <select name="r_state" id="r_state" class="dropdown2" style="width: 334px;">
