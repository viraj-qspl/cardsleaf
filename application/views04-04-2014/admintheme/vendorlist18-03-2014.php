...
?>
  <tr class="<?php echo $class ?>">
    ...
    <td><a href="<?php echo $this->config->item('admin_url')?>member/delete/<?php echo $eachvendorDtls['admin_id'];?>" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a></td>
  </tr>
  <?php 
  	$i++;
    } 
