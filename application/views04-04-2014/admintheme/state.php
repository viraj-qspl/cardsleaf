...
function edit()
{
	$("input[type=checkbox]:checked").each ( function() {
		...
		window.location = "<?php echo site_url('admin/state/edit'); ?>"+"/"+state_id;
	});
...
function trash()
{
	$("input[type=checkbox]:checked").each ( function() {
		var state_id = $(this).val();
		window.location = "<?php echo site_url('admin/state/trash'); ?>"+"/"+state_id;
	});
...
<div class="article_right_alt" style="width:162px;">
	<ul>		
        <li><span><a href="<?php echo site_url('admin/state/add'); ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>images/icon-32-new.png" border="0" /></a></span><br /> <a href="<?php echo site_url('admin/state/add'); ?>">New</a> </li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_box1">
    <tr>
      ...
      <th width="50%"><strong>State name</strong></th>
      <td width="25%" style="text-align: left;"><strong>Country</strong></td>
      <td width="20%"><strong>City count</strong></td>
    </tr>
</table>
...
?>
	...
	{ 
		if($i%2!=0)
		{
			?>
			<tr>
				<td width="5%"><input name="country[]" type="checkbox" value="<?php echo $st["id"]; ?>" /></td>
				<td width="50%" style="text-align: left;"><a href="<?php echo site_url('admin/city/index').'/'.$st["id"]; ?>"> <?php echo $st["name"]; ?> </a></td>                 
				<td width="25%" style="text-align: left;"><?php echo $st["country_name"]; ?></td>                 
                <td width="20%"><input name="" type="text" value="<?php echo $st["city_count"]; ?>" class="textfield1" disabled="disabled" /></td>
			</tr>
			<?php
		} 
		else
