...
?>
  <tr class="<?php echo $class ?>">
    ...
    <td><a href="<?php echo base_url();?>admin/member/carddispatch/<?php echo $allmemberinfo['user_id'];?>/<?php echo $allmemberinfo['img_id'];?>" onclick="return confirm('Are you sure you want to delete this member?');">Dispatch</a></td>
  </tr>
  <?php 
  	$i++;
    } 
