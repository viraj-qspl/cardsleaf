...
<!--	  3rd DIv	   -->
		    ...
		    <div style="border: 1px solid #979797; left: 96px;top: 28px;display: block;height: 504px;overflow: hidden;position: relative;width: 360px; margin:0; position: relative;">
...
<!--	PDF div	-->
		...
		<div class="" style="display: none;" id="img2">
			...
			<div id="img_txt2" style="word-wrap: break-word;width: <?php echo (isset($recentCardDetails['txt2_width']) && $recentCardDetails['txt2_width'] != '') ? $recentCardDetails['txt2_width'] : '256px';?>; height: <?php echo (isset($recentCardDetails['txt2_height']) && $recentCardDetails['txt2_height'] != '') ? $recentCardDetails['txt2_height'] : 'auto';?>; font-size: <?php echo (isset($recentCardDetails['txt2_fsize']) && $recentCardDetails['txt2_fsize'] != '') ? $recentCardDetails['txt2_fsize'] : '16px';?>;">
			<?php if(isset($recentCardDetails['txt2']) && $recentCardDetails['txt2'] != '') { ?>
			<span><?php echo nl2br($recentCardDetails['txt2']); ?></span>
			<?php } else { ?>
			<span></span>
...
<!--	  4th DIv	   -->
		    ...
		    <div style="border: 1px solid #979797; left: 3px;top: 30px;display: block;height: 504px;overflow: hidden;position: relative;width: 360px; margin:0; position: relative;page-break-before: always;">
			<div style="background: none repeat scroll 0 0 #FFFFFF; display: block; height: auto; margin: 365px auto 0; text-align: center; width: 135px;">
			    <div  class="logoview" style="margin: 0 0 5px;"><a><img src="<?php echo $this->config->item('theme_url')?>images/logo.png" border="0" alt="" style="width: 100px;" /></a></div>
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl" id="div1" onclick="get_html('div1');"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01.png" border="0" alt="page01" /></a>Front</li>
