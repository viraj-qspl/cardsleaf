...
<!--	  4th DIv	   -->
	    ...
	    <div class="view4 page" style="display: none;" id="img3">
            	<div style="border: 1px solid #979797; left: 33px;top: 3px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;">
                	<div style="background: none repeat scroll 0 0 #FFFFFF; display: table; height: auto; margin: 270px auto 0; text-align: center; width: 135px;">
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl" id="div1" onclick="get_html('div1');"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01-h.png" border="0" alt="" />Front</a></li>
