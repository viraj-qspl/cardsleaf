...
<!--	  3rd DIv	   -->
		...
		<div class="view3 page" style="display: none;">
		    ...
		    <div style="border: 1px solid #979797; left: 32px;top: 97px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;">
...
<!--	  4th DIv	   -->
	    ...
	    <div class="view4 page" style="display: none;" id="img3">
            	<div style="border: 1px solid #979797; left: 33px;top: 3px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;">
                	<div id="marker" style="background: none repeat scroll 0 0 #FFFFFF; display: block; height: auto; margin: 270px auto 0; text-align: center; width: 135px;">
                    	<div id="logo" style="margin: 0 0 5px;"><a><img src="<?php echo $this->config->item('theme_url')?>images/logo.png" border="0" alt="" /></a></div>
                        <div id="link"><a>www.cardsleaf.com</a></div>
                    </div>
                </div>
            </div>
        </div>
	...
	<form method="post" action="" id="pdffrm">
