...
<div class="mid_container" style="padding: 60px 0px;overflow: hidden;">
   ...
   <!--	  1st DIv   -->
		...
		<div style="border: 1px solid #979797; left: 4px;top: 3px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;">
...
<!--	  3rd DIv	   -->
		...
		<div class="view3 page" style="display: none;">
		    ...
		    <div style="border: 1px solid #979797; left: 32px;top: 97px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;page-break-before: always;">
			    
			<div id="txt2" style="word-wrap: break-word;position: relative; left: <?php echo (isset($recentCardDetails['txt2_left']) && $recentCardDetails['txt2_left'] != '') ? $recentCardDetails['txt2_left'] : '0px';?>; top: <?php echo (isset($recentCardDetails['txt2_top']) && $recentCardDetails['txt2_top'] != '') ? $recentCardDetails['txt2_top'] : '0px';?>;">
...
<!--	PDF div	-->
		...
		<div class="" style="display: none;" id="img2">
		    <div style="border: 1px solid #979797; left: 4px;top: 3px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;page-break-before: always;">
...
<!--	  4th DIv	   -->
	    ...
	    <div class="view4 page" style="display: none;" id="img3">
            	<div style="border: 1px solid #979797; left: 33px;top: 3px;display: block;width: 504px;overflow: hidden;position: relative;height: 360px; margin:0; position: relative;page-break-before: always;">
                	<div style="background: none repeat scroll 0 0 #FFFFFF; display: block; height: auto; margin: 270px auto 0; text-align: center; width: 135px;">
                    	<div style="margin: 0 0 5px;"><a><img src="<?php echo $this->config->item('theme_url')?>images/logo.png" border="0" alt="" style="width: 100px;" /></a></div>
                        <div><a style="color: #777777; cursor: pointer; display: block; font: 11px/14px Arial,Helvetica,sans-serif;  margin: 0; padding: 0; text-align: center; text-decoration: none;">www.cardsleaf.com</a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl" id="div1" onclick="get_html('div1');"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01-h.png" border="0" alt="" /></a>Front</li>
        ...
        <div class="rightcardpl" style="position:relative; height:373px;">
