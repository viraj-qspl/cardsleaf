...
<?php /** NEW LAYOUT STARTS HERE**/ ?>
	...
	<form method="post" action="" enctype="multipart/form-data" name="signupForm" id="signupForm" autocompete="off">
		<div class="in"><input type="text" class="sign_input" placeholder="Email Address" name="email" id="email" onblur="checkEmail()" />
		<span style="display: inline;color: #F00;float: left; font: normal 12px/17px Arial, Helvetica, sans-serif;text-transform: none;" id="email_check"></span>
		</div>
		<div class="in"><input type="password" class="sign_input" placeholder="Password" name="password" id="password" /></div>
		<div class="in"><input type="password" class="sign_input" placeholder="Confirm Password" name="cpassword" id="cpassword" /></div>
		<p>
			<input type="hidden" name="agree" value="agree"/>
			
			<!-- div class="signup"><a href="#"><div class="signup_btn">Signup</div></a></div -->
			
			<div class="signup"><a href="#"><input type="button" class="signup_btn" value="Signup"></a></div>
			
			

		
			<div class="click">By clicking Sign up, you agree to our <a target="_blank" href="<?php echo site_url('home/page/terms_condition')?>">terms & conditions.</a></div><!--click-->

			<div class="word">or</div>
			<div class="facebook"><a  href="javascript:myfunc('fblogin')"><img src="<?php echo $this->config->item('theme_url') ?>newimages/facebook_login.jpg" alt="facebooklogin"></a></div>
	...
	<div class="clear"></div>
	</div><!--container--> <?php /** NEW LAYOUT ENDS HERE**/ ?>
