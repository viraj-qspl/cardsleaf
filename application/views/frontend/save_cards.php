...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#address_form").validate({
            ...
            rules: {
		<?php if($senderInfo['packagechoose']==1) {?>
		remail: {
		    required :true,
		    email:true
		},
		...
		<?php } ?>
            ...
            messages: {
                <?php if($senderInfo['packagechoose']==1) {?>
		remail:"Please type your valid email.",
		<?php }else { ?>
		rname: "Please enter your receiver first name.",
		lname: "Please enter your receiver last name.",
...
<?php if($senderInfo['packagechoose']==1)  $url=base_url().'subscribe/thankyou'; else $url='';?>


        <form method="post" action="<?php echo $url?>" enctype="multipart/form-data" name="address_form" id="address_form" autocompete="off">
	    ...
	    <?php if($senderInfo['packagechoose']==1) {?>
            ...
            <div class="left_side"><div class="about_pic"><img src="<?php echo $this->config->item('theme_url');?>newimages/email_img.jpg"></div></div><!--left_side-->
            
            <div class="mailing">
            <h2>Mailing Address</h2>
            <div class="sign_form">
            <div class="in2"><input type="text" class="sign_input" placeholder="Email Address" name="remail" id="remail"/></div>          
            <p>
            <div class="signup"> <input class="signup_btn"  style="" type="submit" value="Buy" /></div>
            <div class="signup shift" id="prev_page"><a href="javascript:void(0)"><div class="back_btn">Back</div></a></div>
	    ...
	    <label><span class="red">*</span> Last Name:</label>
            ...
            <span class="rightdivbox"><input type="text" name="lname" id="lname" class="textbox2" /></span>
