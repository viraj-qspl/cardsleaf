	...
	$.ajax({
		    ...
		    success: function(response){
					    ...
					    $("div#img_txt2>span").html(obj.recentCardDetails.txt2.replace(/\n/g,"<br>"));
                                            ...
                                            var h = parseInt(504)-parseInt($("div#img_txt2").height());
    ...
    $('#image_file').live('change', function() { 
		...
		$("#imageform").ajaxForm({
			...
			aspectRatio: 200 / obj.newHeight_0,
                        ...
                        var h = parseInt(504)-parseInt(obj.newHeight_0);
                        var top  = parseInt(parseInt(h)/2);
			 $("#rnd").css("left",80);
                         $("#rnd").css("top",top);
...
<div class="mid_container" style="padding: 60px 0px;overflow: hidden;">
	<h2 style="padding-left:82px;">Create Front</h2>
	<div class="leftcardpl">
        ...
        <!--div class="preview_card">
        	<ul>
            	<li class="active pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01.png" border="0" alt="page01" /></a>Front</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page02.png" border="0" alt="page02" /></a>Side</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page03.png" border="0" alt="page03" /></a>Middle</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page04.png" border="0" alt="page04" /></a>Back</li>
            </ul>
        </div-->
        
  			<div class="preview_card">
				<ul>
					<li class="active pagectrl"><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01.png" border="0" alt="" /></a></li>
					<li class="pagectrl"><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page02.png" border="0" alt="" /></a></li>
					<li class="pagectrl"><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page03.png" border="0" alt="" /></a></li>
					<li class="pagectrl"><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page04.png" border="0" alt="" /></a></li>
				</ul>
				<div class="clear"></div>
			</div>	      
	...
	<div class="rightcardpl">
		...
		<!--ul>
			<p>Your are allowed to upload upto  4mb picture</p>
		</ul-->
	    </div> 
		...
		<div class="clear"></div>	  
        <!-- div><input name="make" id="make" type="button" value="Make it now" class="cardbutton" style="display: none;" /></div -->
