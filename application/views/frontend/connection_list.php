   ...
   <div class="members_basebox">
	 ...
	 <div class="profile_right17">
	    <?php if($this->session->userdata('frnd_res_mgs')) { ?>
	       <div class="msg_box" style="width:642px; margin: 10px;"><?php echo $this->session->userdata('frnd_res_mgs'); ?></div>
	       <div class="clear"></div>
	       <?php 
	 ...
	 <div class="clear"></div>
	   ...
	   <div class="messagebasebox">		  
		  ...
		  <ul>
		     <li class="conntionbtn"><a href="<?php echo base_url()?>connection/index" class="here">Request</a></li>
		     <li class="conntionbtn"><a href="<?php echo base_url()?>connection/friends">Request Accepted</a></li>
		 </ul>   
	       </div>
	       <div class="clear"></div>
	       <?php
		  if($connectionData){
	       ...
	       ?>
		  <div class="message_list" style="position: relative;">
		     <div class="list_img3">
		  ...
		  <div class="basebtnboxright">  		  
		     	<p class="conntionbtn17"><a href="<?php echo base_url()?>connection/response/1/<?php echo $eachConData['friend_id'];?>">Accept</a></p>
