...
<section id="body">
    ...
    <div class="login_body">
        ...
        <div class="mid_container">
			...
			<input name="pack" id="pack" type="hidden" value="<?php echo $pack;?>" />
...
<?php } ?>
                            ...
                            <tr>
                                ...
                                <td><div class="dropdown">
                                    <select name="r_state" id="r_state" class="textfield" style="width: 250px;">
...
<?php } ?>
                                    ...
                                    <input type="text" class="textfield" name="or_state" id="or_state" style="width: 250px;"/></div>
                                </td></tr>
                            <tr>
