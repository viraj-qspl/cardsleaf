...
<div class="mid_container" style="padding: 60px 0px; overflow: hidden;">
	<div class="landscape_left">
        ...
        <div class="preview_card">
        	<ul>
            	<li class="active pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page01-h.png" border="0" alt="" /></a>Front</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page02-h.png" border="0" alt="" /></a>Side</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page03-h.png" border="0" alt="" /></a>Middle</li>
                <li class="pagectrl"><span class="photoarrow">&nbsp;</span><a style="cursor: pointer;"><img src="<?php echo $this->config->item('theme_url')?>images/thumb_page04-h.png" border="0" alt="" /></a>Back</li>
            </ul>
        </div>
	</div>
...
<div class="uploadcon_base" style="display: none;" id="upload_text">
    ...
    <div class="optiondiv">
    	<ul>
        	<!--<li>
		    <div><span class="textleft001">Font:</span>
			<select name="" class="boxdrop">
			    <option>Arial</option>
			    <option>Helvetica</option>
			    <option>sans-serif</option>
			    <option>Times New Roman</option>
			    <option>Hand Of Sean</option>
			</select>
		    </div>
		</li>-->
	    ...
	    <li>
	    <div style="position: relative;"><span class="textleft001">Size:</span>
	   
		<input name="fsize" id="fsize" type="text" value="0.0" class="text_drop_field" style="background-color: #ffffff; border: 1px solid #ccc;" />
		<div class="spinner">
		    <span class="spinnerup" id="fsizeup">▲</span>
		    <span class="spinnerdn" id="fsizedn">▼</span>
		</div>
	    ...
	    <!--<li>
	    <div><span class="textleft001">Colour:</span>
	    <div class="divholder">
		<input name="" type="text" class="text_drop_field" />
		<div class="colorpicbox"></div>
	    </div>
	    </div>
	    </li>-->
            
	    <!--<li>
	    <div><span class="textleft001">Style:</span>
	    <select name="fstyle" id="fstyle" class="boxdrop" style="width: auto;">
		<option>Normal</option>
		<option>Bold</option>
		<option>Italic</option>
		<option>BoldItalic</option>
	    </select>
	    </div>
	    </li>-->
