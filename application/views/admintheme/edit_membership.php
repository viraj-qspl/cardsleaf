...
<div class="clear"></div>
<div class="arti">Edit Membership Plan</div>
<div class="clear"></div>
<div class="white_box2" style="width:97%;">
	
<?php //print_r($thememship);?>
...
<tr>
    ...
    <td width="82%"><input name="membership_name" id="membership_name" type="text" value="<?php echo $thememship['name'];?>" class="textfield2" style="width:300px;" /></td>
</tr>

<tr>
    <td>Amount <span style="color: #eb8207;">* </span> </td>
    <td><input name="amount" id="amount" type="text" value="<?php echo $thememship['amt'] ;?>" class="textfield2" style="width:300px;" /></td>
</tr>
<tr>
    <td>Expire-time <span style="color: #eb8207;">* </span> </td>
    <td><input name="exp_time" id="exp_time" type="text" value="<?php echo ($thememship['lifetime'] == 1) ? '' : $thememship['expduration'];?>" class="textfield2" style="width:300px;" <?php if($thememship['lifetime'] == 1) {?> disabled="disabled" <?php } ?> />&nbsp; month(s)</td>
</tr>
<tr>
<tr>
    <td>Life Time </td>
    <td>
	<input name="life_time" id="life_timey" type="radio" value="1" class="textfield2" style="margin:  0 6px 0 0;" onclick="li_enable(this)" <?php if($thememship['lifetime'] == 1) {?> checked="checked" <?php } ?> />
	<label for="life_timey" style="float: left; margin:  0 30px 0 0;">Yes</label>
	<input name="life_time" id="life_timen" type="radio" value="0" class="textfield2" style="margin: 0 6px 0 0;" onclick="li_enable(this)" <?php if($thememship['lifetime'] == 0) {?> checked="checked" <?php } ?>  />
	<label for="life_timen" style="float: left; margin:  0;">No</label>
    </td>
</tr>
    <td>Short Description <span style="color: #eb8207;">* </span> </td>
    <td><textarea name="shrtdes" id="shrtdes" class="textfield2" style="width:300px; height: 100px;"><?php echo $thememship['shrt_des'];?></textarea></td>
</tr>
<tr>
    <td>Best Plan</td>
    <td><input name="bestplan" id="bestplan" type="checkbox" value="<?php echo $thememship['best_plan'];?>" <?php if($thememship['best_plan'] == 1) {?> checked="checked" <?php } ?> onclick="changevalue(this)" class="textfield2" style="width:300px;" /></td>
</tr>
<tr>
    <td>Recurring</td>
    <td><input name="recurring" id="recurring" type="checkbox" value="<?php echo $thememship['recur'];?>" <?php if($thememship['recur'] == 1) {?> checked="checked" <?php } ?> onclick="changevalue(this)" class="textfield2" style="width:300px;" /></td>
</tr>
<tr>
    <td><span style="color: #eb8207;"> </span> </td>
    <td><input type="submit" name="submit" value="Edit Membership Plan" class="btn2"></td>
</tr>
</table>
</div>
