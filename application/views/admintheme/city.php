...
function edit()
{
	$("input[type=checkbox]:checked").each ( function() {
		...
		window.location = "<?php echo site_url('admin/city/edit'); ?>"+"/"+city_id;
	});
...
function trash()
{
	$("input[type=checkbox]:checked").each ( function() {
		var city_id = $(this).val();
		window.location = "<?php echo site_url('admin/city/trash'); ?>"+"/"+city_id;
	});
...
<div class="article_right_alt" style="width:162px;">
	<ul>		
        <li><span><a href="<?php echo site_url('admin/city/add'); ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>images/icon-32-new.png" border="0" /></a></span><br /> <a href="<?php echo site_url('admin/city/add'); ?>">New</a> </li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_box1">
    <tr>
      ...
      <th width="50%"><strong>City name</strong></th>
      <td width="22%" style="text-align: left;"><strong>State</strong></td>
      <td width="23%" style="text-align: left;"><strong>Country</strong></td>
    </tr>
</table>
...
?>
	...
	{ 
		if($i%2!=0)
		{
			?>
			<tr>
				<td width="5%"><input name="city[]" type="checkbox" value="<?php echo $ct["id"]; ?>" /></td>
				<td width="50%" style="text-align: left;"><a href="#"> <?php echo $ct["name"]; ?> </a></td>                 
				<td width="22%" style="text-align: left;"><?php echo $ct["state_name"]; ?> </td> 
                <td width="23%" style="text-align: left;"><?php echo $ct["country_name"]; ?> </td> 
			</tr>
			<?php
		} 
		else
