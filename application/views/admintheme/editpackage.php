...
//echo "<pre>";print_r($thePackDtls);echo "</pre>";
?>
...
<div class="clear"></div>
<div class="arti">Edit Package</div>
<div class="clear"></div>
...
<tr>
    ...
    <td width="82%"><input name="pack_title" id="pack_title" type="text" value="<?php echo $thePackDtls['pack_title'];?>" class="textfield2" style="width:300px;" /></td>
</tr>
<tr>
    <td width="18%">Package Price <span style="color: #eb8207;">* </span> </td>
    <td width="82%"><span style="float: left; margin-right: 5px;line-height: 27px;color:#999;font-size: 25px;">$</span><input name="pack_price" id="pack_price" type="text" value="<?php echo $thePackDtls['pack_price'];?>" class="textfield2" style="width:282px;" /></td>
</tr>
<tr>
    <td>Package Brief <span style="color: #eb8207;">* </span> </td>
    <td><input name="pack_b" id="pack_b" type="text" value="<?php echo $thePackDtls['pack_brief'];?>" class="textfield2" style="width:300px;" /></td>
</tr>
<tr>
    <td>Package Duration <span style="color: #eb8207;">* </span> </td>
    <td><input name="pack_d" id="pack_d" type="text" value="<?php echo $thePackDtls['pack_duration'];?>" class="textfield2" style="width:300px;" />&nbsp;/ Month</td>
</tr>
<tr>
    <td>Package Quantity <span style="color: #eb8207;">* </span> </td>
    <td><input name="pack_q" id="pack_q" type="text" value="<?php echo $thePackDtls['pack_quantity'];?>" class="textfield2" style="width:300px;" />&nbsp;Cards / Month</td>
</tr>
<tr>
    <td>Package Description <span style="color: #eb8207;">* </span> </td>
    <td><textarea name="pack_desc" id="pack_desc" class="ckeditor textarea_bg"><?php echo html_entity_decode($thePackDtls['pack_desc']);?></textarea></td>
</tr>
