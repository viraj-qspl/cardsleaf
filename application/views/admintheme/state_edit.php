...
<div class="article_right">
	<ul>
        ...
        <li style="border-left: 1px solid #c7c7c7; padding-left: 10px;"><span><a style="cursor:pointer;" href="<?php echo site_url('admin/state/index'); ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>images/Cancle_img.png" border="0" /></a></span><br /> <a style="cursor:pointer;" href="<?php echo site_url('admin/state/index'); ?>">Cancel </a></li>
    </ul>
</div>
<div class="clear"></div>
</div>
...
<tr>
    ...
    <td><input name="name" id="name" type="text" value="<?php echo $state['name']; ?>" class="textfield2" style="width: 235px;"/></td>
</tr>
    ...
    <td>
        <div class="styled_select2" style=" width: 245px; margin: 0;">
            <select name="country_id" id="country_id" class="" style="width: 245px;">
                ...
                <option style="width:240px;" value="<?php echo $cont["id"]; ?>" <?php if($state['country_id'] == $cont['id']) { ?> selected="selected" <?php } ?>><?php echo $cont["name"]; ?></option>
                <?php } ?>
            </select>
        </div>
    </td>
