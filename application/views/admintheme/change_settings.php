...
function validation()
{
   ...
   <?php if($this->session->userdata('admin_type')==2) {?>
	...
	var emailID = document.getElementById('admin_username')
	if(emailID.value.search(/\S/) == "-1")
	{
		alert("Please Enter Email.")
		emailID.focus();
...
{ ?>
<tr>
    <td>Account No. <span style="color: #eb8207;">* </span> </td>
    <td><input name="accno" id="accno" type="text" value="<?php echo $admin_info["accountno"]; ?>" class="textfield2" style="width:300px;" /></td>
</tr>
<?php } ?>
