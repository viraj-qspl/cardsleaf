...
function sendinfo(vendor)
{
	window.location = "<?php echo base_url()?>admin/home/sendinfo/"+vendor;
}
...
?>
  <tr class="<?php echo $class ?>">
    ...
    <td><?php echo $eachvendorDtls['lname']; ?></td>
	 <td><?php echo $zone; ?></td>
    <td><?php echo ($eachvendorDtls['accountno']) ? ($eachvendorDtls['accountno']) : '-Not Given-'; ?></td>
    <td><a style="cursor: pointer;" onClick=sendinfo(<?php echo $eachvendorDtls['admin_id'];?>)>Send Information</a></td>
