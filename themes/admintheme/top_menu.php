...
<div id="smoothmenu1" class="ddsmoothmenu">
    ...
    <li style="z-index: 100; "><a href="javascript:void()" style="padding-right: 23px; " class="">CMS Pages</a>
	    ...
	    <li><a href="<?php echo site_url('admin/cms/pages/support'); ?>">Support</a></li>
	    <?php /*?><li><a href="<?php echo site_url('admin/cms/pages/package')?>">Package</a></li><?php */?>
    ...
    <li style="z-index: 100; "><a href="javascript:void()" style="padding-right: 23px; " class="">Member</a>
        <ul style="top: 30px; left: 0px; width: 171px; visibility: visible; display: none; ">
            <li><a href="<?php echo site_url('admin/member/index'); ?>">Paid Member List</a></li>
	</ul>
    </li>
     <li style="z-index: 100; "><a href="javascript:void()" style="padding-right: 23px; " class="">Packages</a>
        <ul style="top: 30px; left: 0px; width: 171px; visibility: visible; display: none; ">
	     <?php /*?><li><a href="<?php echo site_url('admin/home/addpackage'); ?>">Add Package</a></li><?php */?>
            <li><a href="<?php echo site_url('admin/home/listpackage'); ?>">Package List</a></li>
	</ul>
    </li>
    <li style="z-index: 100; "><a href="javascript:void()" style="padding-right: 23px; " class="">Register Vendor</a>
        <ul style="top: 30px; left: 0px; width: 171px; visibility: visible; display: none; ">
            <li><a href="<?php echo site_url('admin/home/vendorlist'); ?>">Register Vendor List</a></li>
	    <li><a href="<?php echo site_url('admin/home/vendor'); ?>">Add Vendor</a></li>
	</ul>
    </li>
     <?php } ?>
