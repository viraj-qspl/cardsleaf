...
<div id="smoothmenu1" class="ddsmoothmenu">
    ...
    <li style="z-index: 100; "><a href="javascript:void()" style="padding-right: 23px; " class="">CMS Pages</a>
	    ...
	    <li><a href="<?php echo site_url('admin/cms/pages/team'); ?>">Team</a></li>
	    <li><a href="<?php echo site_url('admin/cms/pages/careers'); ?>">Careers</a></li>
	    <li><a href="<?php echo site_url('admin/cms/pages/press_media'); ?>">Press & Media</a></li>
