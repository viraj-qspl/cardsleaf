...
<div class="header-mid">
<h1 style="font-size:18px;padding:0 0 0 300px;cursor:pointer;"><a>View Site</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('admin/home/logout'); ?>" title="Logout">Logout</a></h1>
</div>
<div class="header-right"></div>
</div>
<!--<div style="height:30px;"></div>-->
<div style="border: 1px solid #CCC; width: 98%; margin: 0 auto 14px auto; float:none;">
<div class="clear"></div>
