        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            Page = function (contentNode, index, options) {
                ...
                if(
                    ...
                    //if (startingPageNumber==1 || startingPageNumber==3) {
                    if (startingPageNumber==1) {
                        //code
                        contentNode.parent().append('<div style="width:62px; height:100px; margin-left:400px; background-color:#ccc;transform:rotate(-90deg); -ms-transform:rotate(-90deg);"> Click to Flip' + startingPageNumber + '</div>');
                    }
                    else if (startingPageNumber==3) {
                        //code
                        contentNode.parent().append('<div style="width:62px; height:100px; margin-left:400px; background-color:#ccc;transform:rotate(-90deg); -ms-transform:rotate(-90deg);"> Click to Flip3' + startingPageNumber + '</div>');
                    }
                    else
