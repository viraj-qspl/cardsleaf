...
--
-- Host: localhost
-- Generation Time: Apr 09, 2014 at 09:26 AM
...
--
-- Table structure for table `cards_admin`
--

CREATE TABLE IF NOT EXISTS `cards_admin` (
  `admin_id` int(11) NOT NULL AUTO_INCREMENT,
  `username` char(50) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `password` char(100) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `rem_password` varchar(512) CHARACTER SET utf8 NOT NULL,
  `account_type` int(11) NOT NULL COMMENT '1=admin',
  `accountno` varchar(200) NOT NULL,
  `fname` varchar(512) CHARACTER SET utf8 NOT NULL,
  `lname` varchar(512) CHARACTER SET utf8 NOT NULL,
  `email` varchar(222) CHARACTER SET utf8 NOT NULL,
  `api_un` varchar(200) NOT NULL,
  `api_pass` varchar(200) NOT NULL,
  `api_sign` varchar(1024) NOT NULL,
  `paypal_pro_type` varchar(512) NOT NULL,
  `paypal_busi_id` varchar(512) NOT NULL,
  `paypal_sta_type` varchar(512) NOT NULL,
  `active_female_sub` tinyint(1) NOT NULL,
  `no_coin_reg` int(200) NOT NULL,
  `ad1` text NOT NULL,
  `ad2` text NOT NULL,
...
--
-- Dumping data for table `cards_admin`
--

INSERT INTO `cards_admin` (`admin_id`, `username`, `password`, `rem_password`, `account_type`, `accountno`, `fname`, `lname`, `email`, `api_un`, `api_pass`, `api_sign`, `paypal_pro_type`, `paypal_busi_id`, `paypal_sta_type`, `active_female_sub`, `no_coin_reg`, `ad1`, `ad2`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 1, '', 'admin first name', 'admin last name', 'sudipsahaunified@gmail.com', '', '', '', '', '', '', 1, 100, '', ''),
(7, 'durgesh.singh@quoagnitia.com', '40be4e59b9a2a2b5dffb918c0e86b3d7', 'welcome', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', ''),
(6, 'sonia.unified@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '123456', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', ''),
(4, 'juhi.christoper@gmail.com', '40be4e59b9a2a2b5dffb918c0e86b3d7', 'welcome', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', ''),
(5, 'somamukherjee366@yahoo.com', '40be4e59b9a2a2b5dffb918c0e86b3d7', 'welcome', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', ''),
(8, 'durgesh.singh@quagnitia.com', 'cc03e747a6afbbcbf8be7668acfebee5', 'test123', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', ''),
(9, 'shalinikasliwal@gmail.com', 'cc03e747a6afbbcbf8be7668acfebee5', 'test123', 2, '', '', '', '', '', '', '', '', '', '', 0, 0, '', '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=241 ;

--
-- Dumping data for table `cards_country`
--

INSERT INTO `cards_country` (`country_id`, `country_name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `cards_facebookId`
--

CREATE TABLE IF NOT EXISTS `cards_facebookId` (
...
--
-- Dumping data for table `cards_facebookId`
--

INSERT INTO `cards_facebookId` (`id`, `facebook_id`, `email`) VALUES
(1, '100005569234858', 'infotech.unified@gmail.com'),
(2, '100007870055723', 'robinsonhood560@yahoo.com'),
(3, '621945448', 'shalinikasliwal@gmail.com');
...
CREATE TABLE IF NOT EXISTS `cards_img` (
  `img_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'card id',
  `user_id` int(11) NOT NULL,
  `image0` text NOT NULL COMMENT 'image for page 1',
  `img0_top` varchar(20) NOT NULL COMMENT 'position top',
  `img0_left` varchar(20) NOT NULL COMMENT 'position left',
  `img0_width` varchar(20) NOT NULL COMMENT 'width of page 0',
  `img0_height` varchar(20) NOT NULL COMMENT 'height of page 0',
  `image2` text NOT NULL COMMENT 'image for page 3',
  `img2_top` varchar(20) NOT NULL COMMENT 'position top',
  `img2_left` varchar(20) NOT NULL COMMENT 'position left',
  `img2_width` varchar(20) NOT NULL COMMENT 'width of page 2',
  `img2_height` varchar(20) NOT NULL COMMENT 'height of page 2',
  `txt2` text NOT NULL,
  `txt2_top` varchar(20) NOT NULL COMMENT 'text position top',
  `txt2_left` varchar(20) NOT NULL COMMENT 'text position left',
  `txt2_width` varchar(20) NOT NULL COMMENT 'text wrapper width',
  `txt2_height` varchar(20) NOT NULL COMMENT 'text wrapper height',
  `txt2_fsize` varchar(20) NOT NULL COMMENT 'font size of text2 at third page',
  ...
  `f_dob` date NOT NULL,
  `reciver_add1` text NOT NULL,
  `reciver_add2` text NOT NULL,
  `delivery_dt` date NOT NULL,
  `post_date` date NOT NULL,
  `text_message` varchar(1024) NOT NULL,
  `active_status` int(11) NOT NULL COMMENT '0=not paid, 1=Paid',
...
INSERT INTO `cards_img` (`img_id`, `user_id`, `image0`, `img0_top`, `img0_left`, `img0_width`, `img0_height`, `image2`, `img2_top`, `img2_left`, `img2_width`, `img2_height`, `txt2`, `txt2_top`, `txt2_left`, `txt2_width`, `txt2_height`, `txt2_fsize`, `email`, `name`, `lname`, `country`, `state`, `city`, `zipcode`, `contactno`, `f_dob`, `reciver_add1`, `reciver_add2`, `delivery_dt`, `post_date`, `text_message`, `active_status`, `dispatch`) VALUES
(4, 2, '1396674948ins.jpg', '177px', '80px', '', '', '', '', '', '', '', 'ytryrtyn rtyrt y', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-05', '', 0, 0),
(2, 2, '1396673171.jpg', '177px', '80px', '', '', '', '', '', '', '', 'fdgfgdfgdf', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-05', '', 1, 1),
(3, 2, '1396674630t.jpg', '177px', '80px', '', '', '', '', '', '', '', 'dummy', '242px', '54px', '', '', '', '', 'Ashok', 'Das', 99, '1506', 'Kolkata', '700006', '', '0000-00-00', 'qeqweqwveqwe', '', '2014-04-10', '2014-04-05', '', 1, 1),
(5, 2, '1396677904s.jpg', '177px', '80px', '', '', '', '', '', '', '', 'tryrty trrtytry tyt', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-05', '', 0, 0),
(6, 3, '1396855845.jpeg', '185px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '243px', '54px', '407px', '201px', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700091', '9836562389', '0000-00-00', 'Saltlake Sec - v Kolkata - 700091', '', '2014-04-11', '2014-04-07', '', 1, 1),
(7, 3, '1396857105.jpg', '110px', '152px', '', '', '', '', '', '', '', 'This is for testing purpose.', '171px', '124px', '454px', '327px', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700016', '9836562389', '0000-00-00', 'Park street kolkata -700016', '', '2014-04-12', '2014-04-07', '', 1, 1),
(8, 0, '1396860431.jpeg', '119px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose', '243px', '54px', '449px', '298px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-07', '', 0, 0),
(9, 4, '1396860613.jpg', '182px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '243px', '54px', '468px', '360px', '', '', 'Robinson', 'Hood', 99, '1506', 'Kolkata', '700091', '9836562389', '0000-00-00', 'Saltlake Sec - v  Kolkata - 700091', '', '2014-04-11', '2014-04-07', '', 1, 1),
(10, 3, '1396861974.jpeg', '80px', '152px', '', '', '', '', '', '', '', 'This is for testing purpose', '171px', '124px', '256px', '243px', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700091', '9836562389', '0000-00-00', 'Saltlake Sec- v Kolkata - 700091', '', '2014-04-11', '2014-04-07', '', 1, 1),
(11, 5, '1396863657.jpeg', '119px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose', '243px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-07', '', 0, 0),
(12, 6, '1396867377ins.jpg', '105px', '152px', '', '', '', '', '', '', '', 'wwwww', '170px', '124px', '', '', '', '', 'sss', 'www', 99, '1476', 'dfrr', '42444', '23423434434', '0000-00-00', 'dscc34', '', '2014-04-12', '2014-04-07', '', 0, 0),
(20, 3, '1396966223.jpg', '170px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '242px', '54px', '', '', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700016', '9836562389', '0000-00-00', 'Saltlake Sec-1  Kolkata - 700068', '', '2014-04-12', '2014-04-08', '', 1, 0),
(14, 7, '1396940743.jpeg', '152px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose             ', '96px', '54px', '256px', '312px', '', '', 'Liza', 'Roy', 99, '1506', 'Kolkata', '700091', '9836562389', '0000-00-00', 'Saltlake Sec - V Kolkata -- 700091', '', '2014-04-12', '2014-04-08', '', 1, 1),
(15, 5, '1396941817.jpg', '123px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-08', '', 0, 0),
(16, 3, '1396943602.jpg', '46px', '152px', '', '', '', '', '', '', '', 'This is for testing purpose.', '170px', '124px', '', '', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700091', '9836562389', '0000-00-00', 'Saltlake Sec- v Kolkata --  700091', '', '2014-04-12', '2014-04-08', '', 1, 1),
(17, 5, '1396962845ogo.jpg', '174px', '80px', '', '', '', '', '', '', '', 'kokokl', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-08', '', 0, 0),
(18, 3, '1396964032.jpeg', '47px', '152px', '', '', '', '', '', '', '', 'This is for testing purpose.', '156px', '115px', '256px', '274px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-08', '', 1, 1),
(19, 3, '1396965513.jpg', '182px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '242px', '54px', '452px', '368px', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700016', '9836562389', '0000-00-00', 'Park street Kolkata - 700016', '', '2014-04-12', '2014-04-08', '', 1, 1),
(22, 3, '1396966441.jpg', '116px', '152px', '', '', '', '', '', '', '', 'This is for testing purpose.', '170px', '124px', '', '', '', '', 'Juhi', 'Christoper', 99, '1506', 'Kolkata', '700016', '9836562389', '0000-00-00', 'Saltlake Sec- V Kolkata - 700091', '', '2014-04-12', '2014-04-08', '', 1, 0),
(23, 5, '1396969252.jpeg', '128px', '28px', '287px', '287px', '', '', '', '', '', 'This is for testing purpose.', '243px', '54px', '409px', '207px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-08', '', 0, 0),
(24, 8, '1397007455001.JPG', '105px', '152px', '', '', '', '', '', '', '', 'Hello How are you', '170px', '124px', '', '', '', '', 'scscs', 'scscs', 99, '1488', 'scscs', '982728292922233333', '988777888292202', '0000-00-00', 'scscs', '', '2014-04-16', '2014-04-09', '', 0, 0),
(25, 0, '1397027723761.JPG', '4px', '-23px', '520px', '343px', '', '', '', '', '', 'Happy Birthday Dad\n\nLooking forward seeing you soon.\n\n', '142px', '124px', '314px', '122px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(26, 4, '1397027796.jpeg', '152px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose', '242px', '54px', '457px', '19px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(27, 0, '1397027860761.JPG', '114px', '152px', '', '', '', '', '', '', '', 'Happy Birthday Dad\n\nLooking forward seeing you soon.', '151px', '124px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(28, 11, '13970287074.png', '37px', '80px', '', '', '', '', '', '', '', 'ADADAD', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(29, 3, '1397028777.jpg', '177px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose.', '242px', '54px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(30, 5, '1397029482.jpg', '182px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose', '242px', '54px', '432px', '250px', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(31, 0, '1397033182761.JPG', '2px', '-8px', '541px', '357px', '', '', '', '', '', 'Many Happy Returns of the day\n\nMissing You\n\nS.', '132px', '124px', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(32, 0, '1397033547216.JPG', '113px', '152px', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(33, 0, '1397033554216.JPG', '-33px', '-49px', '603px', '401px', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '0000-00-00', '', '', '0000-00-00', '2014-04-09', '', 0, 0),
(34, 9, '1397033843761.JPG', '-4px', '-29px', '576px', '380px', '', '', '', '', '', 'Please jin for the party\n\nMissing you and looking forward to seeing you.', '142px', '124px', '', '', '', '', 'Suraj', 'Jain', 99, '1483', 'delhi', '2440001', '', '0000-00-00', 'A-72 rAM gANGA vIHAR Delhi', '', '2014-04-15', '2014-04-09', '', 0, 0),
(35, 12, '1397034224.jpg', '177px', '80px', '', '', '', '', '', '', '', 'This is for testing purpose', '249px', '83px', '256px', '314px', '', '', 'Rina ', 'Roy', 99, '1506', 'Kolkata', '70001656', '98365623891', '0000-00-00', 'Saltlake sec - v Kolkata - 700091', '', '2014-04-17', '2014-04-09', '', 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cards_package`
--

CREATE TABLE IF NOT EXISTS `cards_package` (
  `pid` int(11) NOT NULL AUTO_INCREMENT,
  `pack_title` varchar(255) NOT NULL,
  `pack_price` varchar(50) NOT NULL,
  `pack_brief` varchar(255) NOT NULL,
  `pack_duration` int(11) NOT NULL,
...
--
-- Dumping data for table `cards_package`
--

INSERT INTO `cards_package` (`pid`, `pack_title`, `pack_price`, `pack_brief`, `pack_duration`, `pack_quantity`, `pack_desc`) VALUES
(1, 'Free', '0', '$0', 0, 0, '&lt;p&gt;\n	Unlimited online cards&lt;/p&gt;\n'),
(2, 'Month – Month club', '4.99', '$4.99/Month', 1, 3, '&lt;p&gt;\n	Unlimited online cards&lt;/p&gt;\n&lt;p&gt;\n	Send 3 Personalized cards a month&lt;/p&gt;\n&lt;p&gt;\n	100% satisfaction guarantee&lt;/p&gt;\n&lt;p&gt;\n	Local Postage Included&lt;/p&gt;\n'),
(3, '6 Months club', '25', '$25 for 6 months 3 Cards per month ', 6, 3, '&lt;p&gt;\n	Unlimited online cards&lt;/p&gt;\n&lt;p&gt;\n	Send 3 Personalized cards a month&lt;/p&gt;\n&lt;p&gt;\n	Pay for long term and save more&lt;/p&gt;\n&lt;p&gt;\n	100% satisfaction guarantee&lt;/p&gt;\n&lt;p&gt;\n	Local Postage Included&lt;/p&gt;\n'),
(4, 'One Year club', '40', '$40 for one year 3 Cards per month And roll over Option', 12, 3, '&lt;p&gt;\n	Unlimited online cards&lt;/p&gt;\n&lt;p&gt;\n	Send 3 Personalized cards a month&lt;/p&gt;\n&lt;p&gt;\n	Pay for a year and get roll over up to 6 cards&lt;/p&gt;\n&lt;p&gt;\n	Pay for long term and save more&lt;/p&gt;\n&lt;p&gt;\n	100% satisfaction guarantee&lt;/p&gt;\n&lt;p&gt;\n	Local Postage Included&lt;/p&gt;\n&lt;p&gt;\n	$19.88 saving from month &amp;ndash; month subscription&lt;/p&gt;\n');

-- --------------------------------------------------------

--
-- Table structure for table `cards_pages`
--

CREATE TABLE IF NOT EXISTS `cards_pages` (
...
--
-- Dumping data for table `cards_pages`
--

INSERT INTO `cards_pages` (`page_id`, `page_name`, `page_content`, `page_link`) VALUES
(1, 'About Us', '&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:15px;&quot;&gt;&lt;b&gt;Cardsleaf&lt;/b&gt; is created to cater to the needs of Indians based overseas who wish to send cards to family and friends in their home country. Cardsleaf helps customers remember and celebrate special occasions with uniquely personalized cards. We have partnered to create Cardsleaf, a best-in-class greeting card app that allows customers to send meaningful cards to India in a matter of minutes.&lt;/span&gt;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&amp;nbsp;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:15px;&quot;&gt;Cardsleaf is all about customers, people and personal connection. When it comes to connect with family and friends back in home country we understand what its needs.&lt;/span&gt;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&amp;nbsp;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:14px;&quot;&gt;&lt;strong&gt;&lt;u&gt;Our Mission&lt;/u&gt;&lt;/strong&gt;&lt;em&gt;:&lt;/em&gt;&lt;/span&gt;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:14px;&quot;&gt;To connect family and friends with personal touch.&lt;/span&gt;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&amp;nbsp;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:14px;&quot;&gt;&lt;u&gt;&lt;strong&gt;Our Promise&lt;/strong&gt;&lt;/u&gt;&lt;em&gt;:&lt;/em&gt;&lt;/span&gt;&lt;/p&gt;\n&lt;p style=&quot;margin-bottom: 0.14in&quot;&gt;\n	&lt;span style=&quot;font-size:15px;&quot;&gt;Quality&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp; &amp;nbsp; &amp;nbsp; &amp;nbsp;&amp;nbsp; Perfection&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp; On time Delivery&lt;/span&gt;&lt;/p&gt;\n', 'aboutus'),
(2, 'Contact Us', '&lt;div style=&quot;margin: 0px; font-size: 12px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center; clear: both;&quot;&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&lt;span style=&quot;font-size:14px;&quot;&gt;\n		&lt;style type=&quot;text/css&quot;&gt;\nP { margin-bottom: 0.08in; direction: ltr; widows: 2; orphans: 2; }A:link { color: rgb(0, 0, 255); }		&lt;/style&gt;\n		Get in touch with customer service group, &lt;/span&gt;&lt;/div&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&amp;nbsp;&lt;/div&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&lt;span style=&quot;font-size:14px;&quot;&gt;Cardsleaf&amp;rsquo;s Customer Service Manager:&lt;br /&gt;\n		support@cardsleaf.com&lt;/span&gt;&lt;br /&gt;\n		&amp;nbsp;&lt;/div&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&amp;nbsp;&lt;/div&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&amp;nbsp;&lt;/div&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px; text-align: left;&quot;&gt;\n		&lt;span style=&quot;font-size:14px;&quot;&gt;&lt;strong&gt;CardsLeaf OFFICES&lt;/strong&gt;&lt;br /&gt;\n		Suite 1200, Bunker Hill Road&lt;br /&gt;\n		Santa Clara CA 95054&lt;br /&gt;\n		United States&lt;/span&gt;&lt;/div&gt;\n&lt;/div&gt;\n&lt;p&gt;\n	&amp;nbsp;&lt;/p&gt;\n', 'contactus'),
(3, 'Privacy', '&lt;p&gt;\n	&amp;nbsp;&lt;/p&gt;\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center;&quot;&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			&lt;strong&gt;Lorem Ipsum&lt;/strong&gt;&amp;nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&amp;#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.&lt;/p&gt;\n	&lt;/div&gt;\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;why&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -52px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &amp;#39;Content here, content here&amp;#39;, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &amp;#39;lorem ipsum&amp;#39; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).&lt;/p&gt;\n	&lt;/div&gt;\n&lt;/div&gt;\n&lt;p&gt;\n	&lt;span style=&quot;color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans; font-size: 11px; text-align: center;&quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center; clear: both;&quot;&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;where&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -26px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of &amp;quot;de Finibus Bonorum et Malorum&amp;quot; (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, &amp;quot;Lorem ipsum dolor sit amet..&amp;quot;, comes from a line in section 1.10.32.&lt;/p&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from &amp;quot;de Finibus Bonorum et Malorum&amp;quot; by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.&lt;/p&gt;\n	&lt;/div&gt;\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;getsome&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -78px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&amp;#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&amp;#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.&lt;/p&gt;\n	&lt;/div&gt;\n&lt;/div&gt;\n&lt;p&gt;\n	&amp;nbsp;&lt;/p&gt;\n', 'privacy'),
(4, 'Terms and Conditions', '&lt;p&gt;\n	&amp;nbsp;&lt;/p&gt;\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center;&quot;&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			&lt;strong&gt;Lorem Ipsum&lt;/strong&gt;&amp;nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&amp;#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.&lt;/p&gt;\n	&lt;/div&gt;\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;why&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -52px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &amp;#39;Content here, content here&amp;#39;, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &amp;#39;lorem ipsum&amp;#39; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).&lt;/p&gt;\n	&lt;/div&gt;\n&lt;/div&gt;\n&lt;p&gt;\n	&lt;span style=&quot;color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans; font-size: 11px; text-align: center;&quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center; clear: both;&quot;&gt;\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;where&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -26px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of &amp;quot;de Finibus Bonorum et Malorum&amp;quot; (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, &amp;quot;Lorem ipsum dolor sit amet..&amp;quot;, comes from a line in section 1.10.32.&lt;/p&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from &amp;quot;de Finibus Bonorum et Malorum&amp;quot; by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.&lt;/p&gt;\n	&lt;/div&gt;\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\n		&lt;h2 class=&quot;getsome&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -78px; background-repeat: no-repeat no-repeat;&quot;&gt;\n			&amp;nbsp;&lt;/h2&gt;\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\n			There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&amp;#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&amp;#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.&lt;/p&gt;\n	&lt;/div&gt;\n&lt;/div&gt;\n&lt;p&gt;\n	&amp;nbsp;&lt;/p&gt;\n', 'terms_condition'),
(5, 'Support', '&lt;p&gt;\r\n	&amp;nbsp;&lt;/p&gt;\r\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center;&quot;&gt;\r\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\r\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\r\n			&lt;strong&gt;Lorem Ipsum&lt;/strong&gt;&amp;nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&amp;#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\r\n		&lt;h2 class=&quot;why&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -52px; background-repeat: no-repeat no-repeat;&quot;&gt;\r\n			&amp;nbsp;&lt;/h2&gt;\r\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\r\n			It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &amp;#39;Content here, content here&amp;#39;, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &amp;#39;lorem ipsum&amp;#39; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;p&gt;\r\n	&lt;span style=&quot;color: rgb(0, 0, 0); font-family: Arial, Helvetica, sans; font-size: 11px; text-align: center;&quot;&gt;&amp;nbsp;&lt;/span&gt;&lt;/p&gt;\r\n&lt;div style=&quot;margin: 0px; font-size: 11px; font-family: Arial, Helvetica, sans; color: rgb(0, 0, 0); text-align: center; clear: both;&quot;&gt;\r\n	&lt;div class=&quot;lc&quot; style=&quot;margin: 0px; clear: left; float: left; width: 348px;&quot;&gt;\r\n		&lt;h2 class=&quot;where&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -26px; background-repeat: no-repeat no-repeat;&quot;&gt;\r\n			&amp;nbsp;&lt;/h2&gt;\r\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\r\n			Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of &amp;quot;de Finibus Bonorum et Malorum&amp;quot; (The Extremes of Good and Evil) by Cicero, written in 45 BC. This book is a treatise on the theory of ethics, very popular during the Renaissance. The first line of Lorem Ipsum, &amp;quot;Lorem ipsum dolor sit amet..&amp;quot;, comes from a line in section 1.10.32.&lt;/p&gt;\r\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\r\n			The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from &amp;quot;de Finibus Bonorum et Malorum&amp;quot; by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n	&lt;div class=&quot;rc&quot; style=&quot;margin: 0px; clear: right; float: right; width: 348px;&quot;&gt;\r\n		&lt;h2 class=&quot;getsome&quot; style=&quot;margin: 0px; padding: 0px; font-weight: normal; font-size: 12px; height: 26px; text-align: left; background-image: url(http://www.lipsum.com/images/en/heading.gif); background-position: 0px -78px; background-repeat: no-repeat no-repeat;&quot;&gt;\r\n			&amp;nbsp;&lt;/h2&gt;\r\n		&lt;p style=&quot;text-align: justify; line-height: 14px; margin: 0px 0px 14px; padding: 0px;&quot;&gt;\r\n			There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&amp;#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&amp;#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.&lt;/p&gt;\r\n	&lt;/div&gt;\r\n&lt;/div&gt;\r\n&lt;p&gt;\r\n	&amp;nbsp;&lt;/p&gt;\r\n', 'support');

-- --------------------------------------------------------

--
-- Table structure for table `cards_payments`
--
...
--
-- Dumping data for table `cards_payments`
--

INSERT INTO `cards_payments` (`id`, `user_id`, `img_id`, `txn_id`, `amount`, `currency`, `fname`, `lname`, `address1`, `address2`, `city`, `state`, `zip`, `country`, `status`, `created`) VALUES
(1, 2, 0, '7BE79245SX144550X', 4.99, 'USD', 'fsdf', 'sdfsdf', '', '', '', '', '', 'US', 'Completed', '2014-04-05 04:52:35'),
(2, 3, 0, '781155295A886435N', 25.00, 'USD', 'juhi', 'christoper', 'Saltlake+sec+-+v+', '', 'Kolkata', 'West Bengal', '700091', 'IN', 'Completed', '2014-04-07 07:30:02'),
(3, 4, 0, '3MC32303RU172430T', 25.00, 'USD', 'Robinson', 'Hood', 'Saltlake+sec+-+v++Kolkata+-+700091', '', 'Kolkata', 'West Bengal', '700091', 'IN', 'Completed', '2014-04-07 08:54:11'),
(4, 7, 0, '6F128633LM194552X', 40.00, 'USD', 'Liza', 'Roy', 'Saltlake+Sec+-+V+Kolkata+-+700091', '', 'Kolkata', 'West Bengal', '700091', 'IN', 'Completed', '2014-04-08 06:58:48'),
(5, 7, 0, '4H326034AM3192222', 40.00, 'USD', 'Liza', 'Roy', 'Saltlake+Sec+-+V+Kolkata+-+700091', '', 'Kolkata', 'West Bengal', '700091', 'IN', 'Completed', '2014-04-08 07:10:46'),
(6, 3, 0, '5NS52252KP4453418', 25.00, 'USD', 'juhi', 'christoper', 'saltlake+sec+-v', '', 'kolkata', 'west bengal', '700091', 'IN', 'Completed', '2014-04-08 13:35:50'),
(7, 3, 0, '5FD772973H253532T', 25.00, 'USD', 'juhi', 'christoper', 'saltlake+sec+-v+', '', 'kolkata', 'west bengal', '700091', 'IN', 'Completed', '2014-04-09 07:35:54'),
(8, 3, 0, '0XF90568NP0309416', 25.00, 'USD', 'juhi', 'christoper', 'saltlake+sec+-1+', '', 'Kolkata', 'West Bengal', '700068', 'IN', 'Completed', '2014-04-09 07:37:26'),
(9, 3, 0, '82486414JN908473G', 40.00, 'USD', 'juhi', 'christoper', 'saltlke+sec+-+1+', '', 'kolkata', 'west bengal', '700068', 'IN', 'Completed', '2014-04-09 07:42:32'),
(10, 12, 0, '1YV00612RT499522W', 4.99, 'USD', 'Rina+', 'Roy', 'Saltlake+Sec+-+V+Kolkata+-+700091', '', 'Kolkata', 'West Bengal', '700091', 'IN', 'Completed', '2014-04-09 09:03:00');

-- --------------------------------------------------------

--
-- Table structure for table `cards_state`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=3961 ;

--
-- Dumping data for table `cards_state`
--

INSERT INTO `cards_state` (`state_id`, `country_id`, `code`, `name`, `status`) VALUES
...
(3956, 240, 'ALD', 'Alderney', 1),
(3957, 240, 'GUE', 'Guernsey', 1),
(3958, 240, 'HRM', 'Herm', 1),
(3959, 240, 'JER', 'Jersey', 1),
(3960, 240, 'SRK', 'Sark', 1);
...
CREATE TABLE IF NOT EXISTS `cards_user` (
  ...
  `packagechoose` int(11) NOT NULL,
  `cardsend` int(11) NOT NULL,
  `buying_dt` date NOT NULL,
  `dncard` text NOT NULL,
  `post_date` date NOT NULL,
...
--
-- Dumping data for table `cards_user`
--

INSERT INTO `cards_user` (`user_id`, `pass`, `rem_pass`, `email`, `fname`, `lname`, `sex`, `birthday`, `country_id`, `state_id`, `city`, `address1`, `address2`, `zip`, `packagechoose`, `cardsend`, `buying_dt`, `dncard`, `post_date`, `status`) VALUES
(1, '', '', 'infotech.unified@gmail.com', 'Unified', 'Infotech', 'M', '0000-00-00', 0, 0, '', '', '', '', 0, 0, '0000-00-00', '', '2014-04-04', 1),
(2, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'sudipsahaunified@gmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 1, 0, '2014-04-05', '1,2,3,5', '2014-04-05', 1),
(3, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'juhi.christoper@gmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 4, 72, '2014-04-09', '6,7,10,16,18,19,20,22', '2014-04-07', 1),
(4, '', '', 'robinsonhood560@yahoo.com', 'Robinson', 'Wood', 'M', '1989-12-01', 0, 0, '', '', '', '', 1, 0, '2014-04-09', '9,26', '2014-04-07', 1),
(5, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'somamukherjee366@yahoo.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 1, 0, '2014-04-09', '11,15,17,23,30', '2014-04-07', 1),
(6, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'snaprvn09@gmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 0, 0, '0000-00-00', '', '2014-04-07', 1),
(7, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'lizaroy487@yahoo.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 4, 70, '2014-04-08', '13,14', '2014-04-08', 1),
(8, '495c7298e69c6b1da9e526542b4f079a', 'panther0', 'cskholia@hotmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 1, 0, '2014-04-09', '', '2014-04-09', 1),
(9, '', '', 'shalinikasliwal@gmail.com', 'Shalini', 'Kasliwal', 'F', '0000-00-00', 0, 0, '', '', '', '', 1, 0, '2014-04-09', '34', '2014-04-09', 1),
(10, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'banerjeem882@gmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 0, 0, '0000-00-00', '', '2014-04-09', 1),
(11, '5e3d1f419312d9f6f9d4fd8e11aefe9b', 'Singh@123', 'durgeshsingh073@gmail.com', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 0, 0, '0000-00-00', '', '2014-04-09', 1),
(12, 'e10adc3949ba59abbe56e057f20f883e', '123456', 'spooky_13in@yahoo.co.in', '', '', 'M', '0000-00-00', 0, 0, '', '', '', '', 2, 3, '2014-04-09', '', '2014-04-09', 1);

-- --------------------------------------------------------

--
-- Table structure for table `cards_user_cap`
--

CREATE TABLE IF NOT EXISTS `cards_user_cap` (
...
--
-- Table structure for table `cards_user_msg`
--

CREATE TABLE IF NOT EXISTS `cards_user_msg` (
